...
#ifndef __REGIONALMINBINARYIMAGE_H_INCLUDED__
#define __REGIONALMINBINARYIMAGE_H_INCLUDED__


/**
 * @file RegionalMinBinaryImage.h
 *
 * @brief  Header file of class qgar::RegionalMinBinaryImage.
 *
 *
 * @author <a href="mailto:qgar-develop@loria.fr?subject=Qgar fwd Mathieu Baeumler">Mathieu Baeumler</a>
 * @date   August 21, 2002  16:20
 * @since  Qgar 2.0
 */
...
/* $Id: RegionalMinBinaryImage.h,v 1.11 2006/03/31 09:32:19 gerald Exp $ */
 ...
 *
 * @class RegionalMinBinaryImage RegionalMinBinaryImage.h "qgarlib/RegionalMinBinaryImage.h"
 *
...
public:
  ...
  /**
   * @brief Reference to qgar::RegionalMinBinaryImage::value_type.
   */
  typedef value_type& reference;

  /**
   * @brief Constant reference to qgar::RegionalMinBinaryImage::value_type.
   */
  typedef const value_type& const_reference;

  /**
   * @brief Pointer to qgar::RegionalMinBinaryImage::value_type.
   */
  typedef value_type* pointer;

  /**
   * @brief Constant pointer to qgar::RegionalMinBinaryImage::value_type.
   */
...
public:
   ...
   */
  explicit RegionalMinBinaryImage(BinaryImage& img);
...
#endif /* __REGIONALMINBINARYIMAGE_H_INCLUDED__ */
