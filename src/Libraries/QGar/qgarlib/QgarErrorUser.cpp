...
/**
 * @file QgarErrorUser.cpp
 * @brief Implementation of class qgar::QgarErrorUser.
 *
 * See file QgarErrorUser.h for the interface.
 *
 *
...
QgarErrorUser::QgarErrorUser(const char* aFuncProfile)
...
QgarErrorUser::QgarErrorUser(const char* aFileName,
                 int aLineNb,
                 const char* aFuncProfile,
                 const string aDiagnostic)

  : logic_error(string(aFuncProfile)),
    AbstractQgarError("USER ERROR",
              aFileName,
              aLineNb,
              aFuncProfile,
              aDiagnostic)
...
QgarErrorUser::~QgarErrorUser() throw()
{
  // VOID
}
