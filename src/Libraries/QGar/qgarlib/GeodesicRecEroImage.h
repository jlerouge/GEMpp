...
#ifndef __GEODESICRECEROIMAGE_H_INCLUDED__
#define __GEODESICRECEROIMAGE_H_INCLUDED__


/**
 * @file GeodesicRecEroImage.h
 *
 * @brief Header file of class qgar::GeodesicRecEroImage.
 *
 *
 * @author <a href="mailto:qgar-develop@loria.fr?subject=Qgar fwd Mathieu Baeumler">Mathieu Baeumler</a>
 * @date   August 13, 2002  15:27
 * @since  Qgar 2.0
 */
...
/* $Id: GeodesicRecEroImage.h,v 1.16 2006/07/04 13:37:42 masini Exp $ */
 ...
 *
 * @class GeodesicRecEroImage GeodesicRecEroImage.h "qgarlib/GeodesicRecEroImage.h"
 *
 * @brief Complete geodesic reconstruction of a grey-level image by erosion.
 *
...
public:
  ...
  /**
   * @brief Reference to qgar::GeodesicRecEroImage::value_type.
   */
  typedef value_type& reference;

  /**
   * @brief Constant reference to qgar::GeodesicRecEroImage::value_type.
   */
  typedef const value_type& const_reference;

  /**
   * @brief Pointer to qgar::GeodesicRecEroImage::value_type.
   */
  typedef value_type* pointer;

  /**
   * @brief Constant pointer to qgar::GeodesicRecEroImage::value_type.
   */
...
public:
   ...
   */
  GeodesicRecEroImage(GreyLevelImage& aMarkImg,
   ...
   */
  static void perform(GreyLevelImage* aMarkImg,
		      GreyLevelImage* aResImg);
...
#endif /* __GEODESICRECEROIMAGE_H_INCLUDED__ */
