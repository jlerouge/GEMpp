...
#ifndef __MASK1DGAUSSD1_H_INCLUDED__
#define __MASK1DGAUSSD1_H_INCLUDED__


/**
 * @file Mask1dGaussD1.h
 *
 * @brief Header file of class qgar::Mask1dGaussD1.
 *
 *
...
/* $Id: Mask1dGaussD1.h,v 1.10 2006/03/31 09:32:17 gerald Exp $ */
 ...
 * @ingroup DS_MASK
 *
 * @class Mask1dGaussD1 Mask1dGaussD1.h "qgarlib/Mask1dGaussD1.h"
 *
 * @brief First derivative of a 1D Gaussian mask.
 *
...
public:
   ...
   *
   * See also qgar::Mask1dGaussD1::operator=,
   ...
   */
  explicit Mask1dGaussD1(double aSigma = 1.0);
   ...
   * @brief Assignment.
   *
   * See also qgar::Mask1dGaussD1(Mask1dGaussD1<T>&),
   *          qgar::GenMask1d::deepCopy,
   *      and qgar::GenMask1d::shallowCopy.
   *
...
#endif /* __MASK1DGAUSSD1_H_INCLUDED__ */
