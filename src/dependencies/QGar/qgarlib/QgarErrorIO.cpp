...
/**
 * @file QgarErrorIO.cpp
 *
 * @brief Implementation of class qgar::QgarErrorIO.
 *
 * See file QgarErrorIO.h for the interface.
 *
 *
...
QgarErrorIO::QgarErrorIO(const char* aFuncProfile)
...
QgarErrorIO::QgarErrorIO(const char* aFileName,
             int aLineNb,
             const char* aFuncProfile,
             const string aDiagnostic)

  : runtime_error(string(aFuncProfile)),
    AbstractQgarError("INPUT/OUTPUT ERROR",
              aFileName,
              aLineNb,
              aFuncProfile,
              aDiagnostic)
