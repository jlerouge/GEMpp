...
#ifndef __GEODESICRECIMAGE_H_INCLUDED__
#define __GEODESICRECIMAGE_H_INCLUDED__


/**
 * @file GeodesicRecImage.h
 *
 * @brief Header file of class qgar::GeodesicRecImage.
 *
 *
...
/* $Id: GeodesicRecImage.h,v 1.16 2006/07/04 13:37:42 masini Exp $ */
 ...
 *
 * @class GeodesicRecImage GeodesicRecImage.h "qgarlib/GeodesicRecImage.h"
 *
 * @brief Complete geodesic reconstruction of a greylevel image by dilation.
 *
...
public:
  ...
  /**
   * @brief Reference to qgar::GeodesicRecImage::value_type.
   */
  typedef value_type& reference;

  /**
   * @brief Constant reference to qgar::GeodesicRecImage::value_type.
   */
  typedef const value_type& const_reference;

  /**
   * @brief Pointer to qgar::GeodesicRecImage::value_type.
   */
  typedef value_type* pointer;

  /**
   * @brief Constant pointer to qgar::GeodesicRecImage::value_type.
   */
...
public:
   ...
   */
  GeodesicRecImage(GreyLevelImage& aMarkImg, GreyLevelImage& aResImg)
   ;
...
#endif /* __GEODESICRECIMAGE_H_INCLUDED__ */
