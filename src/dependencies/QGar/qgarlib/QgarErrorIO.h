...
#ifndef __QGARERRORIO_H_INCLUDED__
#define __QGARERRORIO_H_INCLUDED__


/**
 * @file QgarErrorIO.h
 *
 * @brief Header file of class qgar::QgarErrorIO.
 *
 *
...
/* $Id: QgarErrorIO.h,v 1.11 2007/02/14 17:34:05 masini Exp $ */
 ...
 * @ingroup ERROR
 *
 * @class QgarErrorIO QgarErrorIO.h "qgarlib/QgarErrorIO.h"
 *
 * @brief Class for Qgar Input/Output exceptions.
 *
 *
 * @author <a href="mailto:qgar-develop@loria.fr?subject=Qgar fwd Gerald Masini">Gerald Masini</a>
 * @date   November 12, 2003  16:02
...
public:
   ...
   */
  explicit QgarErrorIO(const char* aFuncProfile);
   ...
   * - diagnostic
   */
  DLL_EXPORT QgarErrorIO(const char* aFileName,
          int aLineNumber,
   ...
   */
  DLL_EXPORT virtual ~QgarErrorIO() throw ();
  //@}
...
#endif /* __QGARERRORIO_H_INCLUDED__ */
