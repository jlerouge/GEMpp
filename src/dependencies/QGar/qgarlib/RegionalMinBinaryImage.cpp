...
/**
 * @file  RegionalMinBinaryImage.cpp
 * @brief Implementation of class qgar::RegionalMinBinaryImage.
 *
 *        See file RegionalMinBinaryImage.h for the interface.
 *
...
#include "RegionalMinBinaryImage.h"
...
// Default constructor
RegionalMinBinaryImage::RegionalMinBinaryImage
(BinaryImage& img) : BinaryImage(img)
{
  perform(this);
}
